...
const seoMeta = {
  en: {
    ...
    ariaLabels: { home: 'Home', about: 'About', professional: 'Professional Experience', projects: 'Projects', resume: 'Resume' },
  },
  de: {
    ...
    ariaLabels: { home: 'Startseite', about: 'Über mich', professional: 'Berufserfahrung', projects: 'Projekte', resume: 'Lebenslauf' },
  },
}
  ...
  return (
    <ToastProvider>
      ...
      <main className="relative z-10" role="main" itemScope itemType="https://schema.org/Person">
        ...
        <section id="resume" aria-label={seo.ariaLabels.resume}><Resume /></section>
      </main>
