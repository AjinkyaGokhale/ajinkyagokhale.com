export const translations = {
  ...
  de: {
    ...
    projects: {
      ...
      skillCategories: [
        { label: 'Cloud',        items: 'AWS (Lambda · EC2 · S3 · DynamoDB · RDS · IoT Core · SES · API Gateway · CloudFormation · IAM · VPC · CloudWatch) · GCP' },
        { label: 'Sprachen',    items: 'Python · Java · JavaScript · C/C++ · Rust · TypeScript · HTML5/CSS3' },
        { label: 'Backend',     items: 'Node.js · Express.js · RESTful APIs · Microservices · Serverless · Event-Driven Architecture' },
        { label: 'Frontend',    items: 'React.js · JavaScript ES6+ · Chrome-Erweiterung · Responsive Design' },
        { label: 'IaC & CI/CD', items: 'AWS CDK v2 · CloudFormation · Terraform · GitHub Actions · CodePipeline · Jenkins' },
        { label: 'Datenbanken', items: 'DynamoDB · PostgreSQL · MySQL · SQL · NoSQL · Datenmodellierung' },
        { label: 'DevOps',      items: 'Docker · CloudWatch · X-Ray · Linux-Administration · Performance-Monitoring' },
        { label: 'IoT/HW',      items: 'AWS IoT Core · MQTT · Raspberry Pi · Arduino · ESP32/NodeMCU · KiCad · Fusion 360' },
      ...
      projects: [
        ...
        {
          name: 'Stromleser IoT-Plattform',
          subtitle: 'Nineti GmbH · AWS IoT-Infrastruktur',
          period: 'Feb 2024 – Heute',
          desc: 'Full-Stack IoT-Plattform (Hardware → Firmware → Cloud → Mobile) zur Verwaltung von Echtzeitdaten von 10.000+ verbundenen Geräten bei 99,9% Verfügbarkeit.',
          bullets: [
            '10.000+ IoT-Geräte auf EC2, Lambda, DynamoDB, IoT Core — 99,9% Verfügbarkeit',
            '20+ Leiterplattendesigns in KiCad; Firmware-Optimierung → 25% schnellere Antwortzeit',
            'MQTT-Echtzeit-Telemetrie mit CloudWatch-Monitoring und automatisierten Benachrichtigungen',
          ],
          tags: ['AWS IoT Core', 'MQTT', 'ESP32', 'KiCad', 'Lambda', 'DynamoDB', 'Firmware'],
        },
      ],
    ...
    resume: {
      ...
      skills: [
        { label: 'Cloud',         value: 'AWS Experte (Lambda · EC2 · S3 · DynamoDB · IoT Core · SES · API Gateway · CloudFormation · IAM · CloudWatch) · GCP' },
        { label: 'Sprachen',      value: 'Python · Java · JavaScript · C/C++ · Rust · TypeScript · HTML5/CSS3' },
        { label: 'Backend',       value: 'Node.js · Express.js · RESTful APIs · Microservices · Serverless · Event-Driven Architecture' },
        { label: 'Frontend',      value: 'React.js · JavaScript ES6+ · Chrome-Erweiterungsentwicklung · Responsive Design' },
        { label: 'IaC/CI-CD',     value: 'AWS CDK v2 · CloudFormation · Terraform · GitHub Actions · CodePipeline · Jenkins' },
        { label: 'Datenbanken',   value: 'DynamoDB · PostgreSQL · MySQL · SQL · NoSQL' },
        { label: 'IoT/HW',        value: 'AWS IoT Core · MQTT · Raspberry Pi · Arduino · ESP32/NodeMCU · KiCad · Fusion 360' },
        { label: 'DevOps',        value: 'Docker · CloudWatch · X-Ray · Linux-Administration' },
      ],
